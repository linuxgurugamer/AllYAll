...
namespace AllYAll
{
    ...
    public class Logger
    {
        ...
        {
            UnityEngine.Debug.Log(_ownerName + ": " +s);
        }
    }
    ...
    public class DMAPI
    {
        ...
        public bool deployDMExperiment(IScienceDataContainer isc, bool HideResultsWindow = false)
        {
    ...
    public class DMModuleScienceAnimateGeneric
    {
        ...
        public void gatherScienceData(ModuleScienceExperiment mse, bool HideResultsWindow = false)
        {
